...
export default async function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="px-6 pt-6 pb-5 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <Link href="/profile/edit" className="text-xs text-orange-500 font-medium flex-shrink-0">
              Edit
            </Link>
          </div>
          {profile.bio ? (
            ...
            <Link href="/profile/edit" className="text-sm text-gray-400 mt-0.5 block">
              Add a bio…
            </Link>
          )}
      ...
      {/* Divider */}
      <div className="border-t border-gray-100 mx-6 mb-1" />
